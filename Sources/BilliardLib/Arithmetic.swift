...
public protocol CanonicalSign {
  func canonicalSign() -> Sign
}

public protocol CanonicalNegation {
  static prefix func -(v: Self) -> Self
}

extension Int: CanonicalNegation { }

public enum Sign {
  case positive
  case negative

  public init(of v: CanonicalSign) {
  ...
  public static func *<T: CanonicalNegation>(_ v: T, _ s: Sign) -> T {
    return (s == .positive) ? v : -v
  }

  public static func *<T: CanonicalNegation>(_ s: Sign, _ v: T) -> T {
    return (s == .positive) ? v : -v
  }
...
public protocol Ring: CustomStringConvertible & Codable & CanonicalNegation & Equatable {
  init(_: Int)
